...
export default function Listings() {
  ...
  return (
    <main>
        ...
        <div className="flex m-4 bg-white shadow-lg flex-col md:flex-row rounded-lg max-w-6xl lg:mx-auto lg:space-x-5">
            <div className="shadow-lg shadow-slate-100 w-full h-[200px] lg-[400px] m-3 ">
              <p className='lg:text-xl sm:text-lg font-bold mb-3 text-blue-900 px-2 '>
             ...
             <MdLocationPin className='h-4 w-4 text-green-600 mr-1 '/>
              ...
              <ul className='flex items-center font-semibold m-1 space-x-2 sm:space-x-6 text-sm '>

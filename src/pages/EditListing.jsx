...
export default function EditListing() {
    ...
    useEffect(()=>{
        if(listing && listing.userRef !== auth.currentUser.uid){
            toast.error('Listing can not be edited');
            navigate('/');
        }
  ...
  return (
    <main className=' max-w-md px-2 mx-auto text-sm sm:text-lg'>
        ...
        <h1 className='font-bold text-center text-3xl mt-6'>Update your Listing</h1>
        <form onSubmit={onSubmit}>
           ...
           />
            ...
            <button type='submit' 
             onSubmit={onSubmit}
             className='w-full text-white  font-medium px-6 py-3 text-center uppercase rounded bg-blue-600 shadow-sm hover:bg-blue-700 hover:shadow-lg transition duration-200 ease-in-out focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg'> Edit listing
            </button>
        </form>
    </main>
  )
